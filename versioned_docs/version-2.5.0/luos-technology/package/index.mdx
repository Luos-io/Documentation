...
As explained in the [architecture page](../basics/orga.mdx), Luos is a platform that handles packages execution.
...
> You can find a view of complete product on [Code organization page](../basics/orga.mdx).
