...
Inspector, exactly like the gate, is a Luos embedded [App service](../luos-technology/services#apps-guidelines), so it is able to be hosted in any Luos running MCU.
