...
In order to begin using this board, you must disable the compliant mode:

```python
robot.dxl_1.compliant = False
```

You can then use the functions and variables of the [Dynamixel module](https://luos-robotics.github.io/module/dxl).
