...
All the cheap neon letters are now lit up by your growing knowledge! We arrive at the last letter of PID: the letter D. Remember there is an [introduction to PID](/blog/an-introduction-to-pid-control-with-dc-motor), a [proportional post](/blog/pid-the-p-as-in-proportional) for the P and an [integral post](/blog/pid-the-i-as-in-integral) for the I. It’s not the end, it’s only the beginning.
