...
All the cheap neon letters are now lit up by your growing knowledge! We arrive at the last letter of PID: the letter D. Remember there is an [introduction to PID](/blog/2020-03-13-control-dc-motor-1), a [proportional post](/blog/2020-08-13-pid-p-proportional) for the P and an [integral post](/blog/2020-09-13-pid-i-integral) for the I. It’s not the end, it’s only the beginning.
