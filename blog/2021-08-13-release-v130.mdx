...
tags: [release, luos]
image: /img/blog/release-v130-luos.png
hide_table_of_contents: false
date: 2021-08-13T10:00
---

# 📢 Luos release announcement v1.3.0:
...
Hello everybody, we are thrilled to share this new release note with you: [**Luos v1.3.0 is out**](https://github.com/Luos-io/Luos/releases/tag/1.3.0)**!**
...
More details about this can be found in the [Gate](https://docs.luos.io/docs/tools/gate) section of our [documentation](https://docs.luos.io/).
...
More details about this can be found in our [documentation](https://docs.luos.io).
...
More details in our [documentation](https://docs.luos.io).
...
More details about this subject in the [messages handling](https://docs.luos.io/docs/luos-technology/message/handling-message) section of our [documentation](https://docs.luos.io).
...
[Click here](https://github.com/Luos-io/Luos/releases) to see all Luos' releases.

TL;DR

You will find below the [original changelog](https://github.com/Luos-io/Luos/releases/tag/1.3.0).
...
🎉 Try it, it's #opensource: [https://github.com/Luos-io/Luos/releases/tag/1.3.0](https://github.com/Luos-io/Luos/releases/tag/1.3.0)
