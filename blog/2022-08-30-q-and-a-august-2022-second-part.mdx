...
The idea is to give you some dependencies, such as you can have with <a href="https://platformio.org/" rel="external nofollow">PlatformIO</a>. For example, you can say: "I want to use this driver service on this application service."
...
Then you can go back to **bootloader mode**, and you will be able to just refresh your application as you it was before the corruption.
...
This vision will allow the developers to get rid of complexity and be able to have the **flexibility and agility** that we have in software today brought in the embedded world.
...
This vision takes money and a lot of time. We are already in a team of nine engineers working full time at Luos, and we need money to make these engineers work on the library.

About our business model, now. As I said, **the Luos engine technology is and will always be free**. You can use it for free, and we will never ask the users to pay for it.
...
We already have **some developers from our community** that want to make developpment and sell their programs or electronic boards (for example, motors or sensors with Luos directly inside).

We will allow to sell various Luos items directly from our Registry, for any developer to buy any item through the Luos platform. It guarantees that such motor or such sensor will be **plug-and-play** directly into your device. This is one of the tools.
...
We also have the `good first issue` tag. This tag applied on an issue means that any user (even those who never used Luos but just want to help this open source initiative) can start they contributing journey with this kind of issue, with easy bugs and improvements. We also have a [documentation page](/docs/contribute-to-luos) to help you through your contributions.

If you want to continue the discussion, feel free to <a href="https://discord.gg/luos" rel="external nofollow">join our Discord community</a>, where you will find a Help channel along with some others, many developers waiting for you. Thank you for attending!
