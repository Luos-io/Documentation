...
![Are microservices optimized for edge and embedded? Q&A live](/assets/images/blog/q-and-a-session-Luos-august-2022-second-part.jpg)
...
Regarding the update capabilities of Luos, because Luos accesses to the network and we also have access to the flash (basically, we need to have these two access to make Luos run), you can compare Luos as [a bootloader](/docs/tools/bootloader).
...
We also have the `good first issue` tag. This tag applied on an issue means that any user (even those who never used Luos but just want to help this open source initiative) can start they contributing journey with this kind of issue, with easy bugs and improvements. We also have a [documentation page](https://www.luos.io/documentation/contribute-to-luos) to help you through your contributions.
