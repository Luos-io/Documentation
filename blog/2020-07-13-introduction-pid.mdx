...
This post will introduce the basics of PID control and why it comes in handy for robotic applications. Discover here an introduction to PID control with DC motor. You don't need much background to read this, but knowing the basics of motors is always a good idea: my previous posts on this subject are listed here: [Welcome to the jungle](/blog/2020-02-13-dc-motor-jungle).
...
We will dig in these [proportional](/blog/2020-08-13-pid-p-proportional), [integral](/blog/2020-09-13-pid-i-integral), and [derivative](/blog/2020-10-13-pid-d-derivative) components on the following posts. We'll look at the maths behind PID control and how to adjust the three constants to get the desired behavior from our motor.
...
Still on the same subject, read now the following article on the [PID: the P as in Proportional](/blog/2020-08-13-pid-p-proportional).
