...
This post will introduce the basics of PID control and why it comes in handy for robotic applications. Discover here an introduction to PID control with DC motor. You don't need much background to read this, but knowing the basics of motors is always a good idea: my previous posts on this subject are listed here: [Welcome to the jungle](/blog/dc-motor-control-welcome-to-the-jungle).
...
> **_Note:_** _Here, I use the same word — control — that in the post_ **_How to stop being controlled by your DC motor: reverse the roles!_** _(_[_part 1: direction_](/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles) _and_ [_part 2: speed_](/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles-2)_). Control is a generic word, and the control I'm talking about today is closer than engineering control, which is more complex than giving a simple speed order to a motor._
...
*   [PID: the P, as in Proportional](/blog/pid-the-p-as-in-proportional)
*   [PID: the I, as in Integral](/blog/pid-the-i-as-in-integral)
*   [PID: D, as in Derivative](/blog/pid-d-as-in-derivative)
...
We will dig in these [proportional](/blog/pid-the-p-as-in-proportional), [integral](/blog/pid-the-i-as-in-integral), and [derivative](/blog/pid-d-as-in-derivative) components on the following posts. We'll look at the maths behind PID control and how to adjust the three constants to get the desired behavior from our motor.
...
Still on the same subject, read now the following article on the [PID: the P as in Proportional](/blog/pid-the-p-as-in-proportional).
