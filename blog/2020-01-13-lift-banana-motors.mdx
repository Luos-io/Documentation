...
You can [get started](https://docs.luos.io/get-started/get-started) with us and our technology step by step!

[Get Started with Luos](https://docs.luos.io/get-started/get-started)

<h2> How do electric motors work? </h2>

Expect some motors of the last category; all the previous ones use electromagnetism to transform electricity into motion. A magnetic field is created by running current into a wire coiled around a bar of iron (which is called an electromagnet). It can attract or repulse either magnets, ferrous materials, or other electromagnets. So, here is the recipe:
...
*   Put current into the coils, one after another, and watch the central magnet rotate, one of its poles attracted to the powered coil.
...
These motors have **cons**: First of all, the quality is associated with the cost (the cheaper, the worst quality). That means sometimes poor materials, weak assemblies, and overheating motors. The brushes, whatever the quality, are a vulnerable part of the motor because they are always in friction with a collector. With time and depending on your use of the motor, brushes wear and create dust; connection is thus not always made with collectors, which results in a significant loss of speed and torque. In the end, all these cons strongly impact the motor's life.

Several famous non-fictional robots have brushed DC motors inside their hardware. Probably some fictional robots have some as well.

Nao, Pepper, Roomba, or Asimo: they all have some brushed DC motors inside (and some other types too).

<h3>  Brushless DC motors </h3>

As the name makes it explicit, this subcategory of DC motors doesn't have brushes and collectors to make the electrical connection between the power supply and rotor.
...
*   A rotating magnetic field is created, making the rotor's magnet turns to "catch" the changing poles:
...
The in-runners BLDC will provide more speed than torque because of their rotor's inertia. On the contrary, out-runners BLDC will have more torque and less speed. Depending on the desired function, this may be a pro or cons.

A significant con is the price, more expensive than their cousins brushed motors. It's explained by many factors (winding construction, magnets, some electronic parts, _etc._).
...
> _Note: Reduction is a crucial part of the whole motorization choice process. To stay in the basics, keep in mind that a reducer — composed of gears assembled — is meant to reduce the speed and, let alone efficiency, to multiply the torque of the motor it is coupled to._
...
[Our tutorials](https://docs.luos.io/docs/luos-technology/services/profile) help you discover how to control your servo motor with Luos.
...
If you want to know more about Luos or help us with this beautiful project, [follow us on Reddit](https://bit.ly/JoinLuosReddit), [join our fantastic community](https://discord.gg/luos), or [star our Luos repository](https://github.com/Luos-io/Luos) on Github.
...
In these following articles, we will talk about DC motors: [how to control a DC motor: welcome to the jungle](https://www.luos.io/blog/dc-motor-control-welcome-to-the-jungle), [How to stop being controlled by your DC motor](https://www.luos.io/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles): Part 1 and [How to stop being controlled by your DC motor](https://www.luos.io/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles): Part 2

Are you ready now to choose the suitable motor for your robot? If yes, congrats, let's dance on Robot Rock!

![](https://uploads-ssl.webflow.com/602cf5c87ad04ea98eaa99da/62208c54b19093d7d9ffc4e6_robot-luos.gif)

Thank you for reading.

— If you liked what you read, please clap the hell out of it and [join us on Discord!](https://discord.com/invite/MRPxBnrRkM)
...
[Simon Baudry](https://www.linkedin.com/in/simon-the-baudry/)