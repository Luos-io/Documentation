...
We go on with the PID letters. This post deals with the I. You can visit the first posts of this series, the [introduction to PID](/blog/2020-03-13-control-dc-motor-1), and the [proportional post](/blog/2020-08-13-pid-p-proportional).
...
In the last post, [the P-post](/blog/2020-08-13-pid-p-proportional), you thought you casually took the computed error and that you multiplied it by a chosen constant, P. But what you did is that you multiplied P by the _calculated last mistake_. At each loop, its value changes:
