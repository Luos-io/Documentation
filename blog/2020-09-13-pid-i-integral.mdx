...
We go on with the PID letters. This post deals with the I. You can visit the first posts of this series, the [introduction to PID](/blog/an-introduction-to-pid-control-with-dc-motor), and the [proportional post](/blog/pid-the-p-as-in-proportional).
...
In the last post, [the P-post](/blog/pid-the-p-as-in-proportional), you thought you casually took the computed error and that you multiplied it by a chosen constant, P. But what you did is that you multiplied P by the _calculated last mistake_. At each loop, its value changes:
