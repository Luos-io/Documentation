...
Remember this image I put in [one of the first posts](/blog/2020-01-13-lift-banana-motors) about motors?
...
We already discussed this in a [previous post](/blog/2020-05-13-read-datasheet), but it's attractive to be precise that this linear curve is theoretical. In your real world, it may look like that:
...
This one is tricky because **_electromotive force_** _and_ **_back electromotive force_** _are the same phenomena_. Only one of them (back-EMF) exerts a mechanical force opposing the motion of the motor, while the other is giving a rotation to the motor (you already know [the process](/blog/2020-01-13-lift-banana-motors), by the way).
...
Of course, you remember this one from [a guide to motors in robotics.](/blog/2020-01-13-lift-banana-motors) Most electric motors run with a magnetic field — not black magic.
