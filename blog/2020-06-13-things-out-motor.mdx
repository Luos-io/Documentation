...
Following your reading and new knowledge on motors, don't hesitate to follow our [Get Started tutorial](https://docs.luos.io/tutorials/get-started) to continue training step by step:
