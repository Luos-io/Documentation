...
Remember this image I put in [one of the first posts](/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics) about motors?
...
We already discussed this in a [previous post](/blog/get-to-know-your-dc-motor-how-to-read-a-datasheet), but it's attractive to be precise that this linear curve is theoretical. In your real world, it may look like that:
...
This one is tricky because **_electromotive force_** _and_ **_back electromotive force_** _are the same phenomena_. Only one of them (back-EMF) exerts a mechanical force opposing the motion of the motor, while the other is giving a rotation to the motor (you already know [the process](/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics), by the way).
...
Of course, you remember this one from [a guide to motors in robotics.](/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics) Most electric motors run with a magnetic field — not black magic.
