...
![img alt](/img/blog/21.png)

No more container, but more profiles

<!--truncate-->

Hello everybody, we are thrilled to share this new release note with you: [**Luos v2.0.0 is out**](https://github.com/Luos-io/Luos/releases/tag/2.0.0)**!**
...
🛠️ Fix: During detection we reset  msg\_allocation outside IRQ
...
🛠️ Fix: Typography on OD\_linear
...
🎉 Try it, it's #opensource: [https://github.com/Luos-io/Luos/releases/tag/2.0.0](https://github.com/Luos-io/Luos/releases/tag/2.0.0)
