...
image: /img/blog/ESP32-and-Luos.png
hide_table_of_contents: false
date: 2022-06-30T11:00
---

![Luos and ESP32](/img/blog/ESP32-and-Luos.png)
...
The ESP32 is a successor to the ESP8266, a breakout hit on Kickstarter. The ESP32 adds Wi-Fi and Bluetooth/BLE support to the already impressive list of features of the ESP8266.
...
ESP32 is based on Tensilica's Xtensa LX6 architecture, incorporating dual-mode Wi-Fi, Bluetooth management, and a DSP. It is often dedicated to the Internet of Things (IoT) and embedded applications because of its low price.
...
Indeed, in the new Luos' release 2.5.0, a Hardware Abstraction Layer (HAL) of Luos engine and an example will allow you to test the Luos technology on those MCU and develop your services for ESP32 family. Follow our tutorial to start with Luos and ESP32.

Luos team developed a HAL based on ESP-IDF SDK provided by Espressif to create a Robus network and natively exchange messages and information through the Luos protocol.

This new covering of MCU family makes Luos compatible with the IoT world product development. It offers the possibility to make new tools for Luos like a gate and an inspector to communicate with an embedded product on a computer through Wi-Fi or Bluetooth.
...
ESP32 is popular worldwide in the maker culture, to create wirelessly connected projects easily through Arduino SDK. Luos engine is also compatible with Arduino SDK. 

It closes the loop by connecting the project between boards and makes it easy to share and reuse the functionality in many innovative projects in prototyping or production phase.

<div align="center">
  <Image src="/img/blog/communication_esp32_arduino_and_luos_engine_white.svg" darkSrc="/img/blog/communication_esp32_arduino_and_luos_engine_dark.svg" alt="Communication principle between Luos engine, Arduino and ESP32" />
</div>
...
![ESP32 Concept explanation](/img/blog/ESP32-concept.png)
...
2. **Product config:** This is a configuration file for your entire Product (*product_config.h*).
3. **Node:** This is the board's code. This is your actual Eclipse, PlatformIO, IAR, or other projects.
4. **Node config:** The configuration file for your node. Define here the specific needs for the node, like pinout or hardware peripheric in HAL (*node_config.h*).
...
Finally, the component will become a package in Luos. It is interesting to note that the component is an independent library that must be compiled and reused in another project. 

Luos' methodology advocates the same concept and provides a registry to simplify package installation and implementation in your product.

Luos fits well with these MCUs. Even if Espressif focuses on hardware, Luos’ approach is more of a methodology and software overlay. You can combine both strong points of these technologies:
