...
Since the Luos release 2.6.0, a new example called **Gate_serialcom** is available and allows you to perform the [Get started with ESP32](/tutorials/get-started/get-started1 evaluation board.
