...
Since the Luos' release 2.6.0, a Gate_serialcom example is available that allow you to perform the [Get started with ESP32](/tutorials/get-started) evaluation board.
...
This new covering of MCU family makes Luos compatible with the IoT world product development. It offers the possibility to make new tools for Luos like a [gate](/docs/tools/gate) and an [inspector](/docs/tools/inspector) to communicate with an embedded product on a computer through Wi-Fi or Bluetooth.
