...
This new covering of MCU family makes Luos compatible with the IoT world product development. It offers the possibility to make new tools for Luos like a [gate](https://www.luos.io/docs/tools/gate) and an [inspector](https://www.luos.io/docs/tools/inspector) to communicate with an embedded product on a computer through Wi-Fi or Bluetooth.
...
Luos' methodology advocates the same concept and will provide a registry to simplify package installation and implementation in your product.
