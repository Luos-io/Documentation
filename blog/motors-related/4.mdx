...
![img alt](/img/blog/4.png)

[Part 1](https://www.luos.io/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles) of this topic was about direction control of your DC motor. Today it's time to have a look at speed control. Everyone curious about robotic motorization basics can read this post, but I suggest you begin with the [guide to motors in robotics](https://www.luos.io/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics), as well as part 1 of this post first.
...
Continue to learn more about DC motors and many other subjects on [our documentation!](https://docs.luos.io/) Several tutorials and videos are waiting for you:

[Discover now](https://docs.luos.io/)
...
— If you liked what you read, please **_clap the hell out of it_** and follow us

By the way, if you want to discover some exciting projects created with Luos and exchange with different people every day, don't hesitate to join our community: [Join us on Discord](https://discord.gg/luos).
