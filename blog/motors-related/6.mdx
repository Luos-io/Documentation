...
![img alt](/img/blog/6.png)

This post is the follow-up of the Motors-in-robotics series. Although what I will present you here is still basic notions and can be addressed to anyone keen on knowing more about it, don't hesitate to have a look at the previous posts ([types of motors in robotics](https://www.luos.io/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics), DC motor [direction](https://www.luos.io/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles), and [speed](https://www.luos.io/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles-2) control, [how to read a datasheet](https://www.luos.io/blog/get-to-know-your-dc-motor-how-to-read-a-datasheet)), they will help you expand your knowledge about electric motors and start on a reasonable basis.
...
Remember this image I put in [one of the first posts](https://www.luos.io/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics) about motors?
...
We already discussed this in a [previous post](https://www.luos.io/blog/get-to-know-your-dc-motor-how-to-read-a-datasheet), but it's attractive to be precise that this linear curve is theoretical. In your real world, it may look like that:
...
Torque (T) (in N.m) is equal to moment of inertia (I) (in kg.m²) times angular acceleration (alpha) (in m/s², all the units here are form SI). This equation appears in [Newton's law of motion](https://en.wikipedia.org/wiki/Rotation_around_a_fixed_axis).

<h2> Back electromotive force </h2>

Also called counter electromotive force, back-EMF, or CEMF. Back-EMF is a voltage (in V), a difference of potential. In the coils of a motor, it appears while electrons are moving through the wires while under a motion of magnetic field ([Lenz's law](https://en.wikipedia.org/wiki/Lenz%27s_law) may explain it better than me).

This one is tricky because **_electromotive force_** _and_ **_back electromotive force_** _are the same phenomena_. Only one of them (back-EMF) exerts a mechanical force opposing the motion of the motor, while the other is giving a rotation to the motor (you already know [the process](https://www.luos.io/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics), by the way).
...
In this equation, R is the resistance of any conductive component, and i is the current which flows through this component. P\_th is the thermal power, _i.e._, the power _(2)_, which is transformed in pure heat emitted from the component.
...
Of course, you remember this one from [a guide to motors in robotics.](https://www.luos.io/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics) Most electric motors run with a magnetic field — not black magic.
...
Following your reading and new knowledge on motors, don't hesitate to follow our [Get Started tutorial](https://docs.luos.io/get-started/get-started) to continue training step by step:
