...
[Part 1](/blog/how-to-stop-being-controlled-by-your-dc-motor-reverse-the-roles) of this topic was about direction control of your DC motor. Today it's time to have a look at speed control. Everyone curious about robotic motorization basics can read this post, but I suggest you begin with the [guide to motors in robotics](/blog/how-to-lift-a-banana-a-guide-to-motors-in-robotics), as well as part 1 of this post first.
...
Continue to learn more about DC motors and many other subjects on [our documentation!](/docs/) Several tutorials and videos are waiting for you.
