...
tags: [embedded, edge]
image: /img/blog/safe-fast-lightweight-luos.png
...
![img alt](/img/blog/safe-fast-lightweight-luos.png)
...
![Representation of computers in a plane](/img/blog/computer-plane-luos.jpeg)
...
![Luos split code into smaller pieces that can be run on several microcontrollers](/img/blog/man-waiting-luos.jpeg)
