...
This post is the follow up of the [introduction post to PID](/blog/2020-03-13-control-dc-motor-1) control for DC motors. They can be read by virtually anyone who can read English, but I highly suggest you to read the introduction post first, as well as the basics about motors listed at the end of [this post](/blog/2020-02-13-dc-motor-jungle).
...
Follow the guide and read the following post where we will talk about [Integral, the I in PID.](/blog/2020-09-13-pid-i-integral)
