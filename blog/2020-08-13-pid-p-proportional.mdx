...
![img alt](/img/blog/8.png)

This post is the follow up of the [introduction post to PID](https://www.luos.io/blog/an-introduction-to-pid-control-with-dc-motor) control for DC motors. They can be read by virtually anyone who can read English, but I highly suggest you to read the introduction post first, as well as the basics about motors listed at the end of [this post](https://www.luos.io/blog/dc-motor-control-welcome-to-the-jungle).
...
Exchange on your PID control projects and meet our community directly on Discord: [Join our Discord](https://discord.gg/luos)
...
Follow the guide and read the following post where we will talk about [Integral, the I in PID.](https://www.luos.io/blog/pid-the-i-as-in-integral)
