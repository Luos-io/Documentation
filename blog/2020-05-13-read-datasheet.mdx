...
*   Terminal resistance and inductance: These are respectively the resistance (in Ohm_, Ω_) and the inductance (in Henry_, H_) of the winding. They are used to calculate various other specs.
...
In order to avoid mistakes, I use a very useful online tool called [Translator Cafe](https://www.translatorscafe.com/unit-converter/), which is trying to save the world everyday.
