...
![What’s the difference of Luos with an embedded OS like ROS? Q&A live](/assets/images/blog/q-and-a-session-Luos-august-2022-first-part.jpg)
...
Luos is not an operating system. This technology allows the developers to **encapsulate any embedded system features** into something we call [service](/documentation/luos-technology/services). 
...
[Microservices](/2021-01-13-unleash-embedded.mdx) are more focused on the web domain than the normal software world, and embedded don't use this kind of methodologies.
...
So, it's easy! We already provide some frameworks, allowing you to deal with Luos using [Python](/tools/pyluos), [ROS](/2022-08-16-ros-controlling-your-distributed-robot-using-micro-ros-and-luos.mdx), etc.
...
So this is a big change for big companies, and right now, we have some guys coming from critical industries: we already have some advanced use cases such as <a href="https://nimbl-bot.com/" rel="external nofollow">Nimbl'bot</a>, a company developing a robot's arm for nuclear plants. They are using these robots directly in the reactor of the nuclear plants. This is a highly [critical usage of Luos](/2022-04-28-distributed-latency.mdx).
...
The only difference is the path to the information, which is the [Luos network](/documentation/luos-technology/node/topology) will use to transmit this information. But the information will still contain the same information.
