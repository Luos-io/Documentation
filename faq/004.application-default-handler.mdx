...
You may change the definition of HAL in _node_config.h_ to fit with your design and your MCU. HAL uses macro to define IRQ handler. However, in the case of pinout in some MCUs, the declarations of IRQ handler are in the a special file _IT.c_.
