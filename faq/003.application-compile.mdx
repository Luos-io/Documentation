...
# The default Luos engine examples does not compile

### Symptom(s)

Luos provides examples for different MCUs, and a HAL for MCU families. You may change HAL definitions in _node_config.h_ to fit with your design and your MCU. After the setup of your environment, building Luos example may create an error with CRC or IrqHandler definitions.
...
- IrqHandler case:
  Check your startup file for the default MCU definition of IrqHandler in you MCU. If Luos engine default configuration does not match with your MCU, you must redefine the used peripherial in `node_config.h`.
