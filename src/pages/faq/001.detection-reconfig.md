...
To do that, add `#define GATE_POLLING` in the file *node_config.h*. The entire list of gate's configuration is available in the [*gate_config.h*](https://github.com/Luos-io/Examples/blob/master/Apps/Gate/gate_config.h) file.
