...
import Form from '@site/src/components/typeform'
...
| Label | Description |
|:---:|:---|
| <Image src="/img/label-help-wanted-light.png" darkSrc="/img/label-help-wanted-dark.png" height="20" /> | This label is our call for contribution. You will see it for issues we need help from the community to work on with us. |
| <Image src="/img/label-good-first-issue-light.png" darkSrc="/img/label-good-first-issue-dark.png" height="20" /> | This label is for issues we consider as easy, and that are good to work on if you want to begin your journey as a contributor. |
| <Image src="/img/label-advanced-light.png" darkSrc="/img/label-advanced-dark.png" height="20" /> | The advanced label is for more complicated issues that will require advanced skills. |
