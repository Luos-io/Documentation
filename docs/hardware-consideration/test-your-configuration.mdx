...
To validate your Robus network's hardware configuration, you can use a Robus tool called _selftest_ available in the <a href="https://github.com/Luos-io/Luos/tree/main/Network/Robus/SelfTest" target="_blank">Luos engine's 'library<IconExternalLink width="10"></IconExternalLink></a>.
