...
Luos engine can manage any type of microcontrollers as long as they have HAL. If your microcontroller is not supported yet, please contact us:
...
Check the list of MCU family Luos engine cover :<a href="https://github.com/Luos-io/Luos/tree/main/Engine/HAL" target="_blank">Hardware Abstraction Layers for MCU Families</a>,

> Depending on your Network you may also configure the specific HAL of your network. By default Luos engine use the Robus network layer with <a href="https://github.com/Luos-io/Luos/tree/main/Network/Robus/HAL" target="_blank">Robus HAL</a>.

## Default Configurations

Luos engine is made to run on MCU and use hardware peripheral of the MCU to complete communication between services. In order to configure this low level part, Luos company provide, for many MCU family, a default configuration that can be follow to plug and play Luos engine with the chosen MCU family. The peripheral configuration is describe in files luos_hal_config.h, and can be redefined in the node_config.h file to fit with your design.

## Luos engine HAL configuration

To match pinout and fonctionality with your design, you can create or use the file `node_config.h` (see [Luos examples](https://github.com/Luos-io/Luos/tree/main/Examples))
