...
Check the list of MCU families Luos engine cover:<a href="https://github.com/Luos-io/Luos/tree/main/Engine/HAL" target="_blank">Hardware Abstraction Layers for MCU families</a>,

> Depending on what network you have, you may also configure the specific HAL of your network. By default, Luos engine uses the Robus network layer with <a href="https://github.com/Luos-io/Luos/tree/main/Network/Robus/HAL" target="_blank">Robus HAL</a>.
...
To match pinout and fonctionality with your design, you can create or use the file _node_config.h_ (see [Luos examples](https://github.com/Luos-io/Luos/tree/main/Examples)).
