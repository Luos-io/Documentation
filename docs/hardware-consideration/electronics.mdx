...
See the default pinout configuration in the <a href="https://github.com/Luos-io/Luos/tree/main/Network/Robus/HAL" target="_blank">_luos_hal_config.h<IconExternalLink width="10"></IconExternalLink>_</a> file, situated in the folder associated to the chosen MCU family.
