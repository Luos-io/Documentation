...
<p className="cust_indent" markdown="1"><img height="150" src="/img/power-isolator-service.png"/></p>
...
<img height="350" src="/img/power_isolator_example.png" alt="Power isolator example image"/>
