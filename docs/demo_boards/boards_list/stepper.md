...
<p className="cust_sheet-title" markdown="1"><strong>Type:</strong> <a href="../../software/containers_list/stepper.md">Stepper</a></p>
...
<p className="cust_indent" markdown="1"><img height="150" src="/img/stepper-container.png" alt="" /></p>
