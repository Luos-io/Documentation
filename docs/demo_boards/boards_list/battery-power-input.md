...
<p className="cust_indent" markdown="1"><img height="150" src="/img/battery-power-input-container.png" alt="" /></p>
...
<a className="github-button" data-size="large" aria-label="Star Luos-io/Luos on GitHub" href="https://github.com/Luos-io/Examples/tree/master/Hardware/wiring_and_power/XT60_power_input" target="_blank">Battery power input</a>
</div>
