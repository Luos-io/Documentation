<h1><a href="#json-api" className="header" id="json-api"><img src="../../_assets/img/json-logo.png" width="80px" alt="" /> / JSON API</a></h1>
...
> **Note:** To understand the meanings of _uuid_ and _port_table_, please refer to the [routing table page](../embedded/containers/routing-table.md).
...
> **Note:** To understand the meanings of _type_, _id_ and _alias_, please refer to the [container page](../embedded/containers.html).
