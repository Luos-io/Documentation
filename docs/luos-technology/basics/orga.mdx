...
Because the Luos engine allows you to manage your features as sharable blocks of code, we organized code in a specific way allowing to easily integrate and share packages from your projects with as little friction as possible.
...
Luos engine library is used at the node level. You will need to initialize the engine and call a loop function on your main program to be able to use the Luos engine API on your packages.

<div align="center">
  <Image
    src="/img/luos_mcu_platform.svg"
    darkSrc="/img/luos_mcu_platform-dark.svg"
  />
</div>
