...
You will find the default configuration for Luos engine in the file <a href="https://github.com/Luos-io/Luos/blob/main/Network/Robus/inc/config.h" target="_blank">_config.h<IconExternalLink width="10"></IconExternalLink>_</a>.
