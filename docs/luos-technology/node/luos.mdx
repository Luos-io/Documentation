...
Luos works as a code library running on nodes. Luos can use several Network interfaces.
To match the Luos library with your hardware, Luos offers a _Hardware Abstraction Layer_ for various devices in <Tooltip def={customFields.luoshal_def}>Luos HAL</Tooltip>.
