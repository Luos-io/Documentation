...
:::caution
Make sure you have read and understood the [network topoly section](../node/topology.mdx) before reading this page.
:::
...
You can read the [services page](../services/services.mdx) for more information about what services are and how they are used.
...
:::info
Routing tables can be easily displayed using [Pyluos](../../tools/pyluos.mdx) through a [USB gate](../../tools/gate.mdx). Please refer to the [Pyluos routing table section](../../tools/pyluos.mdx) for more information.
:::
