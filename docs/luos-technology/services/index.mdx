...
A service can be an [application](./service-api.mdx#apps-guidelines) or a [driver](./service-api.mdx#drivers-guidelines).
...
| **TYPE**  |                                                                                                                                                                             The type defines the service purpose. A few types are predefined and can be used, or new ones can be created. The service type can't be changed after service initialization. See [Type](./service-type.mdx) for more informations.                                                                                                                                                                             | String<br />e.g. `type=DISTANCE_TYPE` |
