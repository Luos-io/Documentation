...
Inspector, exactly like the Gate, is a Luos engine's [app service](../luos-technology/services#apps-guidelines), so it is able to be hosted in any MCU running Luos engine.
