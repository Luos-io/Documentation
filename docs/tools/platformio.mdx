...
Some build flags definition may be use to configure Luos engine when its add in your project. those definition will be taking care of for Luos engine library using Luos script call at building a project with Luos engine. Those definition must be set on platformio.ini
...
| :-------------------: |-------------------------------------------------: | :-------------------: |
|       LUOSHAL         | Define HAL family to use with Luos engine library | <a href="https://github.com/Luos-io/luos_engine/tree/main/engine/HAL" target="_blank" rel="external nofollow"> Luos HAL <IconExternalLink width="10"></IconExternalLink></a> |
|     NOTELEMETRY       |                 Disable Telemetry                 |     On by default     |

Every Luos project need to have a 'node_config.h' file allowing to configure Luos engine hardware dependencies and configure the library. see the [basics  concept page](/docs/luos-technology/basics/orga) for more information.
...
You must define the <a href="https://github.com/Luos-io/luos_engine/tree/main/engine/HAL" target="_blank" rel="external nofollow"> HAL family <IconExternalLink width="10"></IconExternalLink> </a> corresponding to your MCU. see the [compatibility page](/docs/compatibility/mcu_demoboard) to find the HAL familly you must use for your MCU. During build, if a message appears in red, a problem has occurred meaning you forget a build flag in your Platformio.ini file
<div align="center">
...
|      Definition       |                          Description                        |         Value         |
| :-------------------: |-----------------------------------------------------------: | :-------------------: |
|      GATEFORMAT       | Chose the format of data send by the gate to through a pipe | <a href="https://github.com/Luos-io/luos_engine/tree/main/tool_services/gate" target="_blank" rel="external nofollow"> Gate message format <IconExternalLink width="10"></IconExternalLink></a> file|

|      Definition       |                                      Description                                   |         Value         |
| :-------------------: |----------------------------------------------------------------------------------: | :-------------------: |
|       PIPEMODE        | Choose Pipe style to send or receive information through a specific physical Layer | <a href="https://github.com/Luos-io/luos_engine/tree/main/tool_services/pipe" target="_blank" rel="external nofollow"> SERIAL/WS <IconExternalLink width="10"></IconExternalLink></a> |
|       PIPEHAL         |             Choose Pipe HAL match a specific physical Layer with the board         | <a href="https://github.com/Luos-io/luos_engine/tree/main/tool_services/pipe/SERIAL" target="_blank" rel="external nofollow"> Pipe HAL <IconExternalLink width="10"></IconExternalLink></a> | |
