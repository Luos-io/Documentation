...
Checkout the Luos tutorial on <a href="https://www.luos.io/tutorials/pio/creation" target="_blank">how to create a Luos project with PlatformIO <IconExternalLink width="10" /></a>.
