...
On this tutorial, we will use the examples available in [the Luos engine's repository](https://github.com/Luos-io/Luos/tree/main).
...
Open Visual Studio Code and open the **Gate_SerialCom** project corresponding to your master board in **Luos_engine/Examples/Projects/YOUR_BOARD**:
...
The generated binary file can be found in **Luos_engine/Examples/Projects/YOUR_BOARD/Button/.pio/build/\*\_with\_bootloader** under the name _firmware.bin_.
