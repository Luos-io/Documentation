...
:::info
If this step fails, please verify you are properly connected to the USB port or try to follow [the Luos Get started tutorial](../get-started).
:::
...
:::info
If you click on the **Uplad** button, Platformio will use the Luos bootloader CLI to load your firmware. Please do this in command line for now instead...
:::
...
Now, you can use the bootloader command line to load it, for example:
