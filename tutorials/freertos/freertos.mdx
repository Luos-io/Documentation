...
To test your project you can add a Pipe and Gate packages (you can find [available packages on the `Gate_SerialCom` project corresponding to your board](https://github.com/Luos-io/luos_engine/tree/main/Examples/Projects)), add the code in the **lib/** folder and instanciate it by creating a new task in **freertos.c**.
