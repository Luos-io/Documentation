...
In the previous parts of the [Get started tutorial](/tutorial/get-started/), we used Luos Python SDK (pyluos) to be able to code the behavior of your embedded device from your computer. This SDK needs the gate application to translate JSON to Luos and Luos to JSON.
