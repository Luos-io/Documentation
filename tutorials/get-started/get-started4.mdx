...
# Part 4: Connect to the Network Display tool

## 1. Introduction

In the previous parts of the [Get started tutorial](/get-started/get-started), we used Luos Python SDK (pyluos) to be able to code the behavior of your embedded device from your computer. This SDK needs the gate application to translate JSON to Luos and Luos to JSON.
...
1. In VS Code, open the folder *Get_started ****project* corresponding to the board you use.
...
5. Check if the proper board environment is selected depending on your board:
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/0b0d2472-aab4-4803-8d16-ff1ece8c0c11/Untitled.png)
...
3. Click on **Launch Detection** 
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8009e6d9-9f19-45c3-a0ea-80e7099728c7/Untitled.png)
...
4. You should see a selection menu appear. Select The Serial COM where the USB cable is plugged into the board, and click on the **Connexion** button.
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/fdf5ac95-fd67-4ab8-b7b9-aa3eff000785/Untitled.png)
...
6. The Network interface recovers the information from the inspector and displays your nodes and services. Click on the node to see all services in it
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7e4a8896-3931-40f0-b1bd-01d9227b595c/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/bf5f636a-793e-4a02-a31b-1ff99bdbe285/Untitled.png)
