...
With your development environment installed in Part 1, you have now taken the control of a Luos app running on your MCU, with Python. The [next part](/tutorials/get-started)3) of this section deals with creating your first Luos network.
