...
Pyluos provides a set of application programming interfaces (APIs). Keep running in a terminal the program.exe and in a new tab or in another terminal start Pyluos with the following command:

```
`pyluos-shell -p 'localhost'`
```

This command will find through a web socket, your device and mount it into a “device” object.
...
you will see Pyluos coonected through the web socket on the terminal where you run you program.exe
<div align="center">
  <Image
