...
| Function name | Arduino pin | STM32L432KC pin | STM32F072RB pin | STM32F401RE pin | STM32F410RB pin | STM32G431KB pin | Seeeduino XIAO pin |
| ------------- | ----------- | --------------- | --------------- | --------------- | --------------- | --------------- | ------------------ |
| TX            | Tx          | PA9 (D0)        | PA9 (D8)        | PB7(21)         | PB7 (21)        | PA9 (D0)        | D6                 |
| RX            | Rx          | PA10 (D1)       | PA10 (D2)       | PB6 (D10)       | PB6 (D10)       | PA10 (D1)       | D7                 |
| PTP           | D6          | PB5 (D12)       | PA8 (D7)        | PB5 (D5)        | PB5 (D5)        | PB5 (D12)       | D1                 |
...
<Tabs>
  ...
  <TabItem value="Seeeduino Xiao" Seeeduino Xiao">
    <div align="center">
      <Image
        src="/img/get-started/get-started-3-6_light.png"
        darkSrc="/img/get-started/get-started-3-6-dark.png"
      />
    </div>
  </TabItem>
