...
In Part 1, you have downloaded or cloned the Get started code folder in your computer. We will use this code to demonstrate how Luos works using a network. We will begin by moving the blinker app service from _board 1_ to _board 2_ and see what is happening next.
