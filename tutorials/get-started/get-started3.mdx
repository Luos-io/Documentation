...
For example, the current version has been tested with MinGW-w64 (MSVCRT runtime). This library can be downloaded at https://winlibs.com/

:::

5. In a new terminal, run the compiled binary:
```bash
...
1. In VS Code, open the same folder _Get_started/No-Board_: _File/Open folder_.
