...
:::caution
Some board in this get started may not have a LED built in on the board, so you must connect a external LED between the specified Pin and GND
ex for ESP32-DevKit you must connect a LED and a resistor between IO18 and GND (See part3 for Hardware specification)
:::
