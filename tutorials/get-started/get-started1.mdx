...
:::info
**For Arduino users**, you have to select the board you use on the _platformio.ini_ file. For Seeeduino XIAO board modify default_envs = arduino to default_envs = seed. For all the other arduino board leave default_envs = arduino and modifying the `board = zero` line.
