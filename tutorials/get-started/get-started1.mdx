...
- **Gate**, an app that translates Luos message to JSON and sends it through _Pipe_.<br /> ╰ The code folder of this service is located in the cloud (because it is a common cross-platform’s Luos tool), PlatformIO just downloaded it for you.
