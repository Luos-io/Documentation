...
This ESP32 becomes a **node** on the Luos network and must be connected with other nodes by a physical layer: a wire or an RS485 bus. [Read our documentation for more information on hardware](https://www.luos.io/documentation/hardware-consideration/electronics).
