...
Now try to move your led package on another board. Keep only the led package on this second board, and keep Pipe, Gate, and Blinker into the first one. Then wire a OneWire network as you learned in [Part 3 in the _Get started_](/tutorials/get-started/get-started3).
