...
Thanks to that, we can put the service in a folder, move it as we want, and share all our services extremely easily. We call it a [package](/docs/luos-technology/packages).
...
<div align="center">
  <Image
    src="/assets/images/tutorials/your-first-service/luos-service-2.png"
    darkSrc="/assets/images/tutorials/your-first-service/luos-service-2.png"
  />
</div>
...
<div align="center">
  <Image
    src="/assets/images/tutorials/your-first-service/luos-service-2-1.png"
    darkSrc="/assets/images/tutorials/your-first-service/luos-service-2-1.png"
  />
</div>
...
Now try to move your led package on another board. Keep only the led package on this second board, and keep the pipe, the gate, and the blinker into the first one. Then wire a OneWire network as you learned in [Part 3 in the _Get started_](/tutorials/get-started)3).
