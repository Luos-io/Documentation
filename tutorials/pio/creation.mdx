...
- Folder *include*: where you put the project header files.
- Folder *src*: where you put the put project source files.
...
Luos project uses a file, placed at the root of the folder, called *node_config.h*. This file allows you to configure Luos library and match your hardware configuration with Luos default configuration.
...
*platformio.ini* is the project configuration file. You must fill in the file with the information relative to your project.
...
2. Fill in the *main.c* file with the following code:
...
3. The include of *stm32f0xx_hal.h* must be adapted to the STM familly MCU you chose. In our case, ST NUCLEO STM32F072RB → F0 family.
