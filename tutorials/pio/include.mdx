...
:::warning
You have to follow the pinout declared in the file _LuosHAL_Config.h_ for ATSAMD21\*ARDUINO in the [LuosHAL repository](https://github.com/Luos-io/LuosHAL).
:::
...
<div align="center">
  <Image src="/assets/images/tutorials/pio/pio-2-1.png" />
</div>

Upload the code to your MCU by clicking on the right arrow button at the bottom of the IDE.

<div align="center">
  <Image src="/assets/images/tutorials/pio/pio-2-2.png" />
</div>
