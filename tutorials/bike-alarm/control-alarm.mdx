...
:::info
Those custom types are product level information. Following the [Luos project code organization](https://www.luos.io/documentation/next/luos-technology/basics/organization), you should create the `alarm_t` enum into the `product_config.h`.
:::
