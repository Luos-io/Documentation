...
<div align="center">
  <Image
    src="/assets/images/tutorials/your-first-message/your-first-message-2.png"
    darkSrc="/assets/images/tutorials/your-first-message/your-first-message-2.png"
  />
</div>
...
:::info
For more information about the messages, you can refer to [the related documentation page](https://www.luos.io/docs/luos-technology/messages).
:::
...
1. Add the led package created on the [previous tutorial](/tutorials/your-first-service/luos-service) on your board.
